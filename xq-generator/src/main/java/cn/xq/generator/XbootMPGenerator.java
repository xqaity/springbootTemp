package cn.xq.generator;

import cn.hutool.core.util.StrUtil;
import cn.xq.generator.bean.Entity;
import cn.xq.generator.bean.Item;
...
import static cn.xq.generator.XbootGenerator.*;
...
public class XbootMPGenerator {
	 ...
	 * 建议仅需修改
	 */
	private static final String CLASS_NAME = "SysUserRole";

	/**
	 * 类说明描述
	 * 建议仅需修改
	 */
	private static final String DESCRIPTION = "系统用户角色";
	 ...
	 * (文件自动生成至该模块下)
	 */
	private static final String MODULE = "/xq-springboot";

	/**
	 * 模块包路径
	 * （下方包路径拼接使用）
	 */
	private static final String MODULE_PACKAGE = "xqspringboot";

	/**
	 * 实体类对应包
	 * (文件自动生成至该包下)
	 */
	private static final String ENTITY_PACKAGE = "cn.xq." + MODULE_PACKAGE + ".entity";

	/**
	 * dao对应包 【注意修改后需到cn.exrick.xboot.core.config.mybatisplus.MybatisPlusConfig配置你的mapper路径扫描】
	 * (文件自动生成至该包下)
	 */
	private static final String DAO_PACKAGE = "cn.xq." + MODULE_PACKAGE + ".mapper";

	/**
	 * service对应包
	 * (文件自动生成至该包下)
	 */
	private static final String SERVICE_PACKAGE = "cn.xq." + MODULE_PACKAGE + ".service";

	/**
	 * serviceImpl对应包
	 * (文件自动生成至该包下)
	 */
	private static final String SERVICE_IMPL_PACKAGE = "cn.xq." + MODULE_PACKAGE + ".serviceimpl";

	/**
	 * controller对应包
	 * (文件自动生成至该包下)
	 */
	private static final String CONTROLLER_PACKAGE = "cn.xq." + MODULE_PACKAGE + ".controller";
...
//	private static final String CLASS_NAME = "SysUser";
//
//	/**
//	 * 类说明描述
//	 * 建议仅需修改
//	 */
//	private static final String DESCRIPTION = "系统用户";
//
//	/**
//	 * 作者名
//	 * 建议仅需修改
...
//	 * (文件自动生成至该模块下)
//	 */
//	private static final String MODULE = "/xq-core";
//
//	/**
//	 * 模块包路径
//	 * （下方包路径拼接使用）
//	 */
//	private static final String MODULE_PACKAGE = "user";
//
//	/**
//	 * 实体类对应包
//	 * (文件自动生成至该包下)
//	 */
//	private static final String ENTITY_PACKAGE = "base." + MODULE_PACKAGE + ".entity";
//
//	/**
//	 * dao对应包 【注意修改后需到cn.exrick.xboot.core.config.mybatisplus.MybatisPlusConfig配置你的mapper路径扫描】
//	 * (文件自动生成至该包下)
//	 */
//	private static final String DAO_PACKAGE = "base." + MODULE_PACKAGE + ".mapper";
//
//	/**
//	 * service对应包
//	 * (文件自动生成至该包下)
//	 */
//	private static final String SERVICE_PACKAGE = "base." + MODULE_PACKAGE + ".service";
//
//	/**
//	 * serviceImpl对应包
//	 * (文件自动生成至该包下)
//	 */
//	private static final String SERVICE_IMPL_PACKAGE = "base." + MODULE_PACKAGE + ".serviceimpl";
//
//	/**
//	 * controller对应包
//	 * (文件自动生成至该包下)
//	 */
//	private static final String CONTROLLER_PACKAGE = "base." + MODULE_PACKAGE + ".controller";
//
//	/**
//	 * 路径前缀
//	 */
